...
radius, num_levels, min_dist, bs_ht, uav_ht, gn_ht = 1e3, 6, 240.0, 80.0, 200.0, 0.0
data_len, p_avg = [1e6, 10e6, 100e6][1], np.arange(start=1e3, stop=2.2e3, step=0.2e3, dtype=np.float64)[1]
max_iters, eps_abs, eps_rel, warm_start, verbose, csca_conf, csca_tol = int(1e3), 1e-3, 1e-3, True, True, 3, 1e-3
