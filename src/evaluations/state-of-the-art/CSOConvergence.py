...
the CSO algorithm determines the UAV's "optimal" trajectory segments (and their corresponding forward velocities). This
...
os.environ['TF_XLA_FLAGS'] = '--tf_xla_auto_jit=2 --tf_xla_cpu_global_jit ' \
                             '/home/bkeshav1/workspace/repos/Odin/src/uav-mobility/soa-evaluations/CSOConvergence.py'
...
def analyze(n_w):
    ...
    try:
        ...
        with open('../perf-logs/cso-convergence.log', 'w') as f:
            json.dump(lagrs, f)
        return True
...
if __name__ == '__main__':
    print(f'[INFO] CSOConvergence main: Competitive Swarm Optimization | Data Length = {data_len} Mb | '
