...
# data_lens, arr_rates, num_uavs, num_gns = [1e6, 10e6, 100e6], {1e6: 1.67e-2, 10e6: 3.33e-3, 100e6: 5.56e-4}, 2, n
# data_lens, arr_rates, num_uavs, num_gns = [1e6, 10e6, 100e6], {1e6: 1.67e-2, 10e6: 3.33e-3, 100e6: 5.56e-4}, 3, n

"""
Configurations-III: BS and GNs Deployment
"""
...
"""
Core UAV(s) [CIRCLE] Trajectory (Path and Velocity) Initialization
"""
